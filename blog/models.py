...
class Comment(models.Model):
    comment_post_Id = models.BigIntegerField(max_length=20)
...
class Post(models.Model):
    post_author = models.BigIntegerField(max_length=20)
    ...
    post_parent = models.BigIntegerField(max_length=20)
    guid = models.CharField(max_length=255)
    menu_order = models.IntegerField(max_length=11)
...
class Term(models.Model):
    ...
    term_group = models.BigIntegerField(max_length=10)
...
class Term_Taxonomy(models.Model):
    ...
    slug = models.CharField(max_length=200)
    parent = models.BigIntegerField(max_length=20)
    count = models.BigIntegerField(max_length=20)


class Term_Relationship(models.Model):
    term_taxonomy_Id = models.ForeignKey(Term_Taxonomy,on_delete=models.CASCADE)
    term_order = models.IntegerField(max_length=11)
...
class Link(models.Model):
    ...
    link_owner = models.BigIntegerField(max_length=20)
    link_rating = models.IntegerField(max_length=11)
